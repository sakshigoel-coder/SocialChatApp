...
const Other_UserProfile = ({ navigation, route }) => {
    ...
    const loaddata = async () => {
        fetch('http://192.168.0.100:3000/otheruserdata', {
            method: 'POST',
            headers: {
    ...
    const FollowThisUser = async () => {
        ...
        const loggeduserobj = JSON.parse(loggeduser);
        fetch('http://192.168.0.100:3000/followuser', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    const CheckFollow = async (otheruser) => {
        AsyncStorage.getItem('user')
            .then(loggeduser => {
                const loggeduserobj = JSON.parse(loggeduser);
                fetch('http://192.168.0.100:3000/checkfollow', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
    ...
    const UnfollowThisUser = async () => {
        ...
        const loggeduser = await AsyncStorage.getItem('user');
        const loggeduserobj = JSON.parse(loggeduser);
        fetch('http://192.168.0.100:3000/unfollowuser', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
